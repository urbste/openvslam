...
fisheye::fisheye(const std::string& name, const setup_type_t& setup_type, const color_order_t& color_order,
    ...
    : base(name, setup_type, model_type_t::Fisheye, color_order, cols, rows, fps,
           focal_x_baseline, focal_x_baseline / (fx*resize_fac), 64*resize_fac, 48*resize_fac, resize_fac),
      ...
      k1_(k1), k2_(k2), k3_(k3), k4_(k4), resize_fac_(resize_fac) {
