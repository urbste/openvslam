#ifndef OPENVSLAM_OPTIMIZE_G2O_LANDMARK_VERTEX4_CONTAINER_H
#define OPENVSLAM_OPTIMIZE_G2O_LANDMARK_VERTEX4_CONTAINER_H
...
class landmark_vertex4_container {
public:
    /**
     * Constructor
     * @param offset
     * @param num_reserve
     */
    explicit landmark_vertex4_container(const unsigned int offset, const unsigned int num_reserve = 200);

    /**
     * Destructor
     */
    virtual ~landmark_vertex4_container() = default;
     ...
     * @return
     */
    landmark_vertex4* create_vertex(data::landmark* lm, const bool is_constant) {
     ...
     * @return
     */
    landmark_vertex4* create_vertex(const unsigned int id, const Vec3_t& pos_w, const bool is_constant);
     ...
     * @return
     */
    inline landmark_vertex4* get_vertex(data::landmark* lm) const {
     ...
     * @return
     */
    inline landmark_vertex4* get_vertex(const unsigned int id) const {
     ...
     * @return
     */
    inline unsigned int get_id(landmark_vertex4* vtx) const {
    ...
    typedef std::unordered_map<unsigned int, landmark_vertex4*>::iterator iterator;
    typedef std::unordered_map<unsigned int, landmark_vertex4*>::const_iterator const_iterator;
    ...
    std::unordered_map<unsigned int, landmark_vertex4*> vtx_container_;
...
#endif // OPENVSLAM_OPTIMIZE_G2O_LANDMARK_VERTEX4_CONTAINER_H
