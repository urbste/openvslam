...
class shot_vertex_hom_container {
public:
    /**
     * Constructor
     * @param offset
     * @param num_reserve
     */
    explicit shot_vertex_hom_container(const unsigned int offset = 0, const unsigned int num_reserve = 50);

    /**
     * Destructor
     */
    virtual ~shot_vertex_hom_container() = default;
     ...
     * @return
     */
    shot_vertex_hom* create_vertex(data::frame* frm, const bool is_constant) {
     ...
     * @return
     */
    shot_vertex_hom* create_vertex(data::keyframe* keyfrm, const bool is_constant) {
     ...
     * @return
     */
    shot_vertex_hom* create_vertex(const unsigned int id, const Mat44_t& cam_pose_cw, const bool is_constant);
     ...
     * @return
     */
    inline shot_vertex_hom* get_vertex(data::frame* frm) const {
     ...
     * @return
     */
    inline shot_vertex_hom* get_vertex(data::keyframe* keyfrm) const {
     ...
     * @return
     */
    inline shot_vertex_hom* get_vertex(const unsigned int id) const {
     ...
     * @return
     */
    inline unsigned int get_id(shot_vertex_hom* vtx) {
    ...
    typedef std::unordered_map<unsigned int, shot_vertex_hom*>::iterator iterator;
    typedef std::unordered_map<unsigned int, shot_vertex_hom*>::const_iterator const_iterator;
...
private:
    ...
    std::unordered_map<unsigned int, shot_vertex_hom*> vtx_container_;
